<?php
// Heading
$_['heading_title']      = 'Oschadpay';
$_['text_edit']       = 'Edit module';
// Text 
$_['text_payment']       = 'Payment';
$_['text_oplata']       	 = '<a onclick="window.open(\'http://www.oschadbank.ua/\');"><img src="view/image/payment/oplata.png" alt="Oschadpay" title="Oschadpay" style="border: 1px solid #EEEEEE;" /></a>';
$_['text_success']       = 'Settings updated';   
$_['text_pay']           = 'Oschadpay';
...
$_['entry_styles']		=	'Oschadpay Styles';
