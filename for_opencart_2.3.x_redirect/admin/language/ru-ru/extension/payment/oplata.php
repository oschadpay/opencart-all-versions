...
$_['text_oplata']       	 = '<a onclick="window.open(\'http://www.oschadbank.ua\');"><img src="view/image/payment/oplata.png" alt="Oschadpay" title="Oplata" style="border: 1px solid #EEEEEE;" /></a>';
